...
local Library = loadstring(game:HttpGet("https://raw.githubusercontent.com/naypramx/Ui__Project/Script/Asss"))()
local Windown = Library:Win("Blox Fruit | Tool")
local Main = Windown:Channel("Main")
local Item = Windown:Channel("Item")
local Shop = Windown:Channel("Shop")

---------------------------------------------------------------------------------------------------

local Mastery = Main:Addpage("AutoFarm Mastery")
local WeaponInfo = Main:Addpage("Weapon Infomation")

local AutoItem = Item:Addpage("Auto Item")

local Melee = Shop:Addpage("Fighting Style")
local Sword = Shop:Addpage("Sword")
local GunAcc = Shop:Addpage("Gun & Accessories")
local Fragments = Shop:Addpage("Fragments")

---------------------------------------------------------------------------------------------------

local AutoFarmSword = Mastery:Toggle("All-Sword",false,function(a)
    AutoSwordMastery = a
    if not a and TweenFa then
        game:GetService("RunService").RenderStepped:Wait()
        TweenFa:Cancal()
    end
end)
...
_G.SwordMastery = 350
Mastery:slider("Sword-Mastery",1,600,350,function(a)
    _G.SwordMastery = a
end)
...
WeaponInfo:Label("Dark Blade: ✅")


---------------------------------------------------------------------------------------------------

AutoItem:Button("Auto TrueTriple-Katana",function()
...
Melee:Label("Fighting Style")
Melee:Button("Black Leg",function()
	game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("BuyBlackLeg")
end)
Melee:Button("Electro",function()
	game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("BuyElectro")
end)
Melee:Button("Fishman Karate",function()
	game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("BuyFishmanKarate")
end)
Melee:Button("Dragon Claw",function()
	game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("BlackbeardReward", "DragonClaw", "2")
end)
Melee:Button("Superhuman",function()
	game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("BuySuperhuman")
end)
Melee:Button("Death Step",function()
	game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("BuyDeathStep")
end)
Melee:Button("Sharkman Karate",function()
	game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("BuySharkmanKarate")
end)
Melee:Button("Electric Claw",function()
    game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("BuyElectricClaw")
end)
Melee:Button("Dragon Talon",function()
...
Sword:Label("Sword")
Sword:Button("Katana ( $1K Beli )",function()
    game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("BuyItem", "Katana")
end)
Sword:Button("Cutlass ( $1K Beli )",function()
    game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("BuyItem", "Cutlass")
end)  
Sword:Button("Dual Katana ( $12K Beli )",function()
    game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("BuyItem", "Dual Katana")
end)
Sword:Button("Iron Mace ( $25K Beli )",function()
    game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("BuyItem", "Iron Mace")
end)
Sword:Button("Triple Katana ( $60K Beli )",function()
    game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("BuyItem", "Triple Katana")
end)
Sword:Button("Pipe ( $100K Beli )",function()
    game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("BuyItem", "Pipe")
end)
Sword:Button("Dual-Headed Blade ( $400K Beli )",function()
    game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("BuyItem", "Dual-Headed Blade")
end)
Sword:Button("Soul Cane ( $750K Beli )",function()
    game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("BuyItem", "Soul Cane")
end)
Sword:Button("Bisento ( $1.2M Beli )",function()
...
GunAcc:Label("Gun")
GunAcc:Button("Slingshot ( $5K Beli )",function()
	game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("BuyItem", "Slingshot")
end)
GunAcc:Button("Musket ( $8K Beli )",function()
	game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("BuyItem", "Musket")
end)
GunAcc:Button("Flintlock ( $10.5K Beli )",function()
	game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("BuyItem", "Flintlock")
end)
GunAcc:Button("Refined Slingshot ( $30K Beli )",function()
	game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("BuyItem", "Refined Slingshot")
end)
GunAcc:Button("Refined Flintlock ( $65K Beli )",function()
	game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("BuyItem", "Refined Flintlock")
end)
GunAcc:line()
GunAcc:Label("Accessories")
GunAcc:Button("Black Cape ( $50K Beli )",function()
    game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("BuyItem", "Black Cape")
end)
GunAcc:Button("Swordsman Hat ( $150k Beli )",function()
    game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("BuyItem", "Swordsman Hat")
end)
GunAcc:Button("Tomoe Ring ( $500k Beli )",function()
...
Fragments:Button("Random Race ( f3K Fragments )",function()
    game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("BlackbeardReward", "Reroll", "2")
end)
Fragments:Button("Reset Stats ( f2.5K Fragments )",function()
    ...
    while wait() do
        pcall(function()
            if AutoSwordMastery then
                ...
                elseif SwordName and CheckMastery(SwordName) >= _G.SwordMastery then
                    ...
                    if game:GetService("Workspace").Enemies:FindFirstChild("Reborn Skeleton [Lv. 1975]") or game:GetService("Workspace").Enemies:FindFirstChild("Living Zombie [Lv. 2000]") or game:GetService("Workspace").Enemies:FindFirstChild("Domenic Soul [Lv. 2025]") or game:GetService("Workspace").Enemies:FindFirstChild("Posessed Mummy [Lv. 2050]") then
                        for i,v in pairs(game:GetService("Workspace").Enemies:GetChildren()) do
                            if AutoSwordMastery and table.find(HauntedMon, v.Name) and v:FindFirstChild("Head") and v:FindFirstChild("Humanoid") and v:FindFirstChild("HumanoidRootPart") and v.Humanoid.Health > 0 and (game:GetService("Workspace")["_WorldOrigin"].Locations["Haunted Castle"].Position - v.HumanoidRootPart.Position).Magnitude <= 1000 then
                                repeat task.wait()
                                    ...
                                    Magnet = true
                                until not AutoSwordMastery or not v:FindFirstChild("Humanoid") or not v:FindFirstChild("HumanoidRootPart") or not v:FindFirstChild("Head") or v.Humanoid.Health <= 0 or (game:GetService("Workspace")["_WorldOrigin"].Locations["Haunted Castle"].Position - v.HumanoidRootPart.Position).Magnitude > 1000
                            end
                        end
...
spawn(function()
    while task.wait() do
        pcall(function()
            if AutoSwordMastery and Magnet then
                for i,v in pairs(game:GetService("Workspace").Enemies:GetChildren()) do
